...
var Converse = function () {
  ...
  _createClass(Converse, null, [{
     ...
     */
    value: function setMemory(token, conversation_token, memory) {
      var data = { conversation_token: conversation_token, memory: JSON.stringify(memory) };
      var request = {
        method: 'put',
    ...
    key: 'resetMemory',
    value: function resetMemory(token, conversation_token, alias) {
      var memory = {};
      memory[alias] = null;
      var data = { conversation_token: conversation_token, memory: JSON.stringify(memory) };
      var request = {
    ...
    value: function resetConversation(token, conversation_token) {
      var request = {
        method: 'delete',
        url: _constants2.default.CONVERSE_ENDPOINT,
        headers: { Authorization: 'Token ' + token },
