...
var Response = function Response(response) {
  ...
  this.isNegated = function () {
    return _this.negated === 0;
  };

  this.isAssert = function () {
    return _this.act === _config2.default.ACT_ASSERT;
  };

  this.isCommand = function () {
    return _this.act === _config2.default.ACT_COMMAND;
  };

  this.isWhQuery = function () {
    return _this.act === _config2.default.ACT_WH_QUERY;
  };

  this.isYnQuery = function () {
    return _this.act === _config2.default.ACT_YN_QUERY;
  };

  this.isAbbreviation = function () {
    return _this.type.indexOf(_config2.default.TYPE_ABBREVIATION) !== -1;
  };

  this.isEntity = function () {
    return _this.type.indexOf(_config2.default.TYPE_ENTITY) !== -1;
  };

  this.isDescription = function () {
    return _this.type.indexOf(_config2.default.TYPE_DESCRIPTION) !== -1;
  };

  this.isHuman = function () {
    return _this.type.indexOf(_config2.default.TYPE_HUMAN) !== -1;
  };

  this.isLocation = function () {
    return _this.type.indexOf(_config2.default.TYPE_LOCATION) !== -1;
  };

  this.isNumber = function () {
    return _this.type.indexOf(_config2.default.TYPE_NUMBER) !== -1;
  };

  this.isPositive = function () {
    return _this.sentiment === _config2.default.SENTIMENT_POSITIVE;
  };

  this.isNeutral = function () {
    return _this.sentiment === _config2.default.SENTIMENT_NEUTRAL;
  };

  this.isNegative = function () {
    return _this.sentiment === _config2.default.SENTIMENT_NEGATIVE;
  };
